...
namespace Business.Services
{
    ...
    public class TCIdentityNumberVerify
    {
        public static bool CheckTCIdentityNumber(ulong identityNumber, String firstName, String lastName, ushort dateOfBirthYear)
        {
            TCKimlikDogrulama.TCKimlikNoDogrula tcKimlikDogrulama = new TCKimlikDogrulama.TCKimlikNoDogrula();
            tcKimlikDogrulama.TCKimlikNo = identityNumber;
            tcKimlikDogrulama.Ad = firstName;
            tcKimlikDogrulama.Soyad = lastName;
            tcKimlikDogrulama.DogumYili = dateOfBirthYear;
            ...
            {
                Console.WriteLine("TC Kimlik No Doğrulanamadı. Mesaj: " + ex.Message);
            }
